...
const ALLOWED_CATEGORY_NAMES = ['Все товары', 'Подносы', 'Кашпо для цветов', 'Менажницы', 'Подставки сервировочные', 'Держатели кухонные', 'Мыльницы', 'Стаканы для ванной комнаты', 'Держатели для телефонов ручные', 'Блюда декоративные', 'Подносы', 'Подсвечники', 'Подставки для украшений', 'Вазы для цветов', 'Столики интерьерные', 'Светильники подвесные', 'Зеркала интерьерные']
